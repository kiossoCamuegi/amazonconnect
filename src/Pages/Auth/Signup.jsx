             ...
             <div className="form-area">
                 <div className="form-box">
                    <Form>
                        <div className="info">
                            <Logo index={1} />
                            <h1>Hello !Start now.</h1>
                            <p>Sign up with your data and make whatever you want after registered.</p> 
                        </div>
                        ...
                        <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                          <Form.Label>Password</Form.Label>
                          <Form.Control type="password" placeholder="123kiosso#" />
                        </Form.Group>
                         <button className="btn col bg-black text-light">Signup</button>
                        <div className="or">
                        ...
                        <div className="d-flex mt-2">Already have an account ? <Link to="/signin" className='text-yellow'> signin</Link> </div>
                    </Form>
                 </div>
             </div>
        </div>
